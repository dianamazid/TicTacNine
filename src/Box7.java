...
public class Box7 extends JFrame implements ActionListener {
	...
	public Box7(String box, boolean turn, TicTacNine t) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((one.getText() == "X" && two.getText() == "X" && three.getText() == "X")
			...
			JOptionPane.showMessageDialog(Box7.this, "Player 1 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.seven.setFont(newFont);
			ttn.seven.setText("X");
			ttn.seven.setIcon(david);
			...
			JOptionPane.showMessageDialog(Box7.this, "Player 2 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.seven.setFont(newFont);
			ttn.seven.setText("O");
			ttn.seven.setIcon(nada);

			this.dispose();
			board.dispose();
			ttn.checkFullWin();
		} else if (counter == 10) {
			JOptionPane.showMessageDialog(Box7.this, "It's a tie!");
		}
	}
