...
public class Box8 extends JFrame implements ActionListener {
	...
	public Box8(String box, boolean turn, TicTacNine t) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((one.getText() == "X" && two.getText() == "X" && three.getText() == "X")
			...
			JOptionPane.showMessageDialog(Box8.this, "Player 1 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.eight.setFont(newFont);
			ttn.eight.setText("X");
			ttn.eight.setIcon(david);
			...
			JOptionPane.showMessageDialog(Box8.this, "Player 2 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.eight.setFont(newFont);
			ttn.eight.setText("O");
			ttn.eight.setIcon(nada);
			
			this.dispose();
			board.dispose();
			ttn.checkFullWin();
		} else if (counter == 10) {
			JOptionPane.showMessageDialog(Box8.this, "It's a tie!");
		}
	}
