...
public class Box4 extends JFrame implements ActionListener {
	...
	public Box4(String box, boolean turn, TicTacNine t) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((one.getText() == "X" && two.getText() == "X" && three.getText() == "X")
			...
			JOptionPane.showMessageDialog(Box4.this, "Player 1 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.four.setFont(newFont);
			ttn.four.setText("X");
			
			ttn.four.setIcon(david);
			...
			JOptionPane.showMessageDialog(Box4.this, "Player 2 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.four.setFont(newFont);
			ttn.four.setText("O");
			ttn.four.setIcon(nada);

			this.dispose();
			board.dispose();
			ttn.checkFullWin();
		} else if (counter == 10) {
			JOptionPane.showMessageDialog(Box4.this, "It's a tie!");
		}
	}
