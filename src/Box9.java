...
public class Box9 extends JFrame implements ActionListener {
	...
	public Box9(String box, boolean turn, TicTacNine t) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((one.getText() == "X" && two.getText() == "X" && three.getText() == "X")
			...
			JOptionPane.showMessageDialog(Box9.this, "Player 1 Wins!");
			
			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.nine.setFont(newFont);
			ttn.nine.setText("X");
			ttn.nine.setIcon(david);
			...
			JOptionPane.showMessageDialog(Box9.this, "Player 2 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.nine.setFont(newFont);
			ttn.nine.setText("O");
			ttn.nine.setIcon(nada);
			...
			JOptionPane.showMessageDialog(Box9.this, "It's a tie!");
		}
	}
