...
public class Box2 extends JFrame implements ActionListener {
	...
	public Box2(String box, boolean turn, TicTacNine t) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((one.getText() == "X" && two.getText() == "X" && three.getText() == "X")
			...
			JOptionPane.showMessageDialog(Box2.this, "Player 1 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.two.setFont(newFont);
			ttn.two.setText("X");
			
			ttn.two.setIcon(david);
			...
			JOptionPane.showMessageDialog(Box2.this, "Player 2 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.two.setFont(newFont);
			ttn.two.setText("O");
			ttn.two.setIcon(nada);
			...
			JOptionPane.showMessageDialog(Box2.this, "It's a tie!");
		}
	}
