...
public class Box6 extends JFrame implements ActionListener {
	...
	public Box6(String box, boolean turn, TicTacNine t) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((one.getText() == "X" && two.getText() == "X" && three.getText() == "X")
			...
			JOptionPane.showMessageDialog(Box6.this, "Player 1 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.six.setFont(newFont);
			ttn.six.setText("X");
			
			ttn.six.setIcon(david);
			...
			JOptionPane.showMessageDialog(Box6.this, "Player 2 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.six.setFont(newFont);
			ttn.six.setText("O");
			ttn.six.setIcon(nada);

			this.dispose();
			board.dispose();
			ttn.checkFullWin();
		} else if (counter == 10) {
			JOptionPane.showMessageDialog(Box6.this, "It's a tie!");
		}
	}
