...
public class Box3 extends JFrame implements ActionListener {
	...
	public Box3(String box, boolean turn, TicTacNine t) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((one.getText() == "X" && two.getText() == "X" && three.getText() == "X")
			...
			JOptionPane.showMessageDialog(Box3.this, "Player 1 Wins!");
			
			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.three.setFont(newFont);
			ttn.three.setText("X");
			
			ttn.three.setIcon(david);
			...
			JOptionPane.showMessageDialog(Box3.this, "Player 2 Wins!");

			Font currentFont = nine.getFont();
			Font newFont = new Font("Arial", Font.PLAIN, (int) ((double) 1/2));
			ttn.three.setFont(newFont);
			ttn.three.setText("O");
			ttn.three.setIcon(nada);
			...
			JOptionPane.showMessageDialog(Box3.this, "It's a tie!");
		}
	}
